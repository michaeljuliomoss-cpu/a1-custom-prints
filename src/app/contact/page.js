        ...
        <div className="container" style={{ maxWidth: '680px' }}>
          ...
          <form onSubmit={handleSubmit} className="configurator">
            ...
            <div className="config-group">
              ...
              <input className="config-select" type="email" required
                value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })}
                placeholder="your@email.com" />
            </div>
            <div className="config-group">
              <label className="config-label">Phone</label>
              <input className="config-select" type="tel"
                value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })}
                placeholder="+1 (242) ..." />
            </div>
            <div className="config-group">
              <label className="config-label">Category</label>
              <select className="config-select" value={form.category}
            ...
            <div className="config-group">
              ...
              <textarea className="config-select" style={{ minHeight: '120px', resize: 'vertical' }} required
